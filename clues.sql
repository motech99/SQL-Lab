...
ORDER BY population
LIMIT 1;
-- answer: VAT  Holy See (Vatican City State)
...
WHERE C.code = 'VAT';
-- answer: she's attending italian language classes 
...
-- answer: she moved to SMR San Marino       
...
-- answer: she's flying to Serravalle
